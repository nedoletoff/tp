...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/paint-brush.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/layer-shape-polygon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.polygonButton.setIcon(icon4)
        self.polygonButton.setCheckable(True)
        self.polygonButton.setObjectName("polygonButton")
        self.gridLayout.addWidget(self.polygonButton, 5, 1, 1, 1)
        ...
        self.dropperButton.setIcon(icon7)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/layer-shape-round.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.roundrectButton.setIcon(icon9)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icons/layer-shape-ellipse.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.addRecButton = QtWidgets.QPushButton(self.centralWidget)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/types/rectangle.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.addRecButton.setIcon(icon12)
        self.addRecButton.setObjectName("addRecButton")
        self.verticalLayout_3.addWidget(self.addRecButton)
        self.addSawButton = QtWidgets.QPushButton(self.centralWidget)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/types/saw.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.addSawButton.setIcon(icon13)
        self.addSawButton.setObjectName("addSawButton")
        self.verticalLayout_3.addWidget(self.addSawButton)
        self.addTriangleButton = QtWidgets.QPushButton(self.centralWidget)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/types/triangle.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.addTriangleButton.setIcon(icon14)
        self.addTriangleButton.setObjectName("addTriangleButton")
        self.verticalLayout_3.addWidget(self.addTriangleButton)
        ...
        self.menuBar.setGeometry(QtCore.QRect(0, 0, 706, 30))
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/icons/blue-folder-open-image.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionOpenImage.setIcon(icon15)
        self.actionOpenImage.setObjectName("actionOpenImage")
        self.actionSaveImage = QtWidgets.QAction(MainWindow)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/icons/disk.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSaveImage.setIcon(icon16)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/icons/document-image.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionNewImage.setIcon(icon17)
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/icons/edit-bold.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionBold.setIcon(icon18)
        self.actionBold.setObjectName("actionBold")
        self.actionItalic = QtWidgets.QAction(MainWindow)
        self.actionItalic.setCheckable(True)
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/icons/edit-italic.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionItalic.setIcon(icon19)
        self.actionItalic.setObjectName("actionItalic")
        self.actionUnderline = QtWidgets.QAction(MainWindow)
        self.actionUnderline.setCheckable(True)
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/icons/edit-underline.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionUnderline.setIcon(icon20)
        ...
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/icons/paint-can-color.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionFillShapes.setIcon(icon21)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Lab3.2"))
        self.addRecButton.setText(_translate("MainWindow", "Rectangle"))
        self.addSawButton.setText(_translate("MainWindow", "Saw"))
        self.addTriangleButton.setText(_translate("MainWindow", "Triangle"))
